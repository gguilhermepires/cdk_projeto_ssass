...
echo Starting cdk_front_payment...
start cmd /k "cd /d "%~dp0cdk_front_payment" && call run.bat"

echo Starting cdk_front_login...
start cmd /k "cd /d "%~dp0cdk_front_login" && call run.bat"

echo Starting cdk_front_app_shell...
start cmd /k "cd /d "%~dp0cdk_front_app_shell" && call run.bat"
